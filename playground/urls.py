...
from .views import appointments_by_user, create_non_polymorphic, generate_users, delete_users, get_polymorphic, get_unencrypted_users, get_users, get_usernames, get_ethnicities, delete_data, generate_appointment_data, generate_unencrypted_users, unencrypted_appointment_by_user, wipe_data
...
urlpatterns = [
    ...
    path('create_non_polymorphic', create_non_polymorphic, name="create_polymorphic"),
